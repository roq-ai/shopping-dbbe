...
export function ProductListPage(props: ProductListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getProducts({
        relations: ['organization', 'animation.count', 'discount.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('organization', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('animation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'animation',
          header: 'Animation',
          accessorKey: 'animation',
          cell: ({ row: { original: record } }: any) => record?._count?.animation,
        }
      : null,
